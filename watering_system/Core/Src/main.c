...
/*
 * moisture 100% = (2020, 2050)
 * moisture 0%   = (4070. 4095)
 *
 * flux 100% => adc_val = 75
 * flux 0%   => adc_val = 4095
 *
...
uint8_t data_0[]  = {0};
uint16_t data_25[] = {65000};
uint8_t data_50[] = {50};
uint8_t data_100[]= {100};

char time_buffer[100];		//buffer that will hold data for time and date
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  //transmit string to uart for debugging
	  //Todo transmit this to 0.96 display
